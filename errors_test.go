...
func TestProviderError_Is(t *testing.T) {
	tests := []struct {
		...
		{"stream read", llm.NewErrStreamRead(llm.ProviderNameOllama, errors.New("eof")), llm.ErrStreamRead},
		{"stream decode", llm.NewErrStreamDecode(llm.ProviderNameOpenRouter, errors.New("bad json")), llm.ErrStreamDecode},
