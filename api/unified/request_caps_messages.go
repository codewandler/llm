...
// BuildMessagesRequest builds the wire request.
...
// DefaultAnthropicMessagesModelCaps is the built-in model capability resolver for
// Anthropic models. It is used by BuildMessagesRequest when no custom resolver
// is injected via WithMessagesModelCaps.
//
// Providers with access to a live model registry can override this with a
// more accurate lookup via MessagesOption WithMessagesModelCaps.
