...
// Send stamps ev with the stream's RequestID and sends it on the channel.
...
type StreamEvent struct {
	...
	// Generated by the provider via NewRequestID() and set on the StreamEventStart event.
	// Consumers can use it to correlate log entries across a single request lifecycle.
