...
var modelRegistry = map[string]modelInfo{
	...
	// Claude 4.x series
	"anthropic.claude-opus-4-6-v1":              {ID: "anthropic.claude-opus-4-6-v1", Name: "Claude Opus 4.6", InputPrice: 0, OutputPrice: 0},
	"anthropic.claude-sonnet-4-6":               {ID: "anthropic.claude-sonnet-4-6", Name: "Claude Sonnet 4.6", InputPrice: 0, OutputPrice: 0},
	"anthropic.claude-opus-4-5-20251101-v1:0":   {ID: "anthropic.claude-opus-4-5-20251101-v1:0", Name: "Claude Opus 4.5", InputPrice: 0, OutputPrice: 0},
	...
	"anthropic.claude-haiku-4-5-20251001-v1:0":  {ID: "anthropic.claude-haiku-4-5-20251001-v1:0", Name: "Claude Haiku 4.5", InputPrice: 0, OutputPrice: 0},
	"anthropic.claude-opus-4-1-20250805-v1:0":   {ID: "anthropic.claude-opus-4-1-20250805-v1:0", Name: "Claude Opus 4.1", InputPrice: 0, OutputPrice: 0},
	"anthropic.claude-opus-4-20250514-v1:0":     {ID: "anthropic.claude-opus-4-20250514-v1:0", Name: "Claude Opus 4", InputPrice: 0, OutputPrice: 0},
	...
	// Claude 3.x series
	"anthropic.claude-3-7-sonnet-20250219-v1:0": {ID: "anthropic.claude-3-7-sonnet-20250219-v1:0", Name: "Claude 3.7 Sonnet", InputPrice: 0, OutputPrice: 0},
	...
	// --- Meta Llama models ---
	// Llama 4
	"meta.llama4-maverick-17b-instruct-v1:0": {ID: "meta.llama4-maverick-17b-instruct-v1:0", Name: "Llama 4 Maverick 17B", InputPrice: 0, OutputPrice: 0},
	"meta.llama4-scout-17b-instruct-v1:0":    {ID: "meta.llama4-scout-17b-instruct-v1:0", Name: "Llama 4 Scout 17B", InputPrice: 0, OutputPrice: 0},
	...
	// Llama 3
	"meta.llama3-70b-instruct-v1:0": {ID: "meta.llama3-70b-instruct-v1:0", Name: "Llama 3 70B Instruct", InputPrice: 0, OutputPrice: 0},
	"meta.llama3-8b-instruct-v1:0":  {ID: "meta.llama3-8b-instruct-v1:0", Name: "Llama 3 8B Instruct", InputPrice: 0, OutputPrice: 0},

	// --- Amazon Nova models ---
	"amazon.nova-premier-v1:0": {ID: "amazon.nova-premier-v1:0", Name: "Amazon Nova Premier", InputPrice: 0, OutputPrice: 0},
	"amazon.nova-pro-v1:0":     {ID: "amazon.nova-pro-v1:0", Name: "Amazon Nova Pro", InputPrice: 0.80, OutputPrice: 3.20},
	"amazon.nova-2-lite-v1:0":  {ID: "amazon.nova-2-lite-v1:0", Name: "Amazon Nova 2 Lite", InputPrice: 0, OutputPrice: 0},
	...
	"mistral.pixtral-large-2502-v1:0":       {ID: "mistral.pixtral-large-2502-v1:0", Name: "Pixtral Large", InputPrice: 0, OutputPrice: 0},
	...
	"mistral.mistral-7b-instruct-v0:2":      {ID: "mistral.mistral-7b-instruct-v0:2", Name: "Mistral 7B Instruct", InputPrice: 0, OutputPrice: 0},
